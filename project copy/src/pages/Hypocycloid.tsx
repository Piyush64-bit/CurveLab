...
function Hypocycloid() {
  const [params, setParams] = useState<HypocycloidParams>({
    R: 100,
    r: 30,
    amplitude: 150,
    color: "#ffffff",
  ...
  const updateParam = useCallback(
    (key: keyof HypocycloidParams, value: number | string) => {
  ...
  const downloadSVG = useCallback(() => {
    ...
    link.href = url;
    link.download = `hypocycloid-curve-${Date.now()}.svg`;
  ...
  return (
    <div className="min-h-screen bg-black overflow-x-hidden">
      <Helmet>
        <title>Designer | Hypocycloid</title>
      </Helmet> 
      <Topbar />
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      value={params.R}
                      onChange={(e) =>
                        updateParam("R", parseInt(e.target.value))
                      }
                      className="w-full h-2 bg-white/[0.1] rounded-lg appearance-none cursor-pointer slider-mono"
                    />
                  </div>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateParam("strokeWidth", parseInt(e.target.value))
                      }
                      className="w-full h-2 bg-white/[0.1] rounded-lg appearance-none cursor-pointer slider-mono"
                    />
                  </div>
