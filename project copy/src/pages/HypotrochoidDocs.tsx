...
import {HypotrochoidLogo} from "../components/Logos";
...
const PerformanceIcon = () => (
  <svg width="24" height="24" viewBox="0 0 20 20" fill="currentColor" className="text-white flex-shrink-0 self-center sm:w-7 sm:h-7">
...
const HypotrochoidDocs: React.FC = () => {
  return (
    <div className="min-h-screen bg-black text-white">
      <Helmet>
        <title>Docs | Hypotrochoid</title>
      </Helmet>       
      ...
      <div className="relative z-10 px-4 sm:px-6 py-8 sm:py-12 md:py-16 lg:py-24">
        <div className="max-w-5xl mx-auto">
          ...
          <section className="mb-8 sm:mb-12">
            ...
            <div className="bg-white/[0.02] backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border border-white/[0.08]">
              <p className="text-gray-400 font-light mb-3 sm:mb-4 text-sm sm:text-base">
                A hypotrochoid is the curve traced by a point attached to a circle rolling inside a larger fixed circle, with the tracing point offset by a distance <code className="bg-black/50 px-1 rounded text-xs sm:text-sm">d</code> from the center of the rolling circle.
              </p>
              <ul className="list-disc list-inside text-gray-300 space-y-1 sm:space-y-2 text-sm sm:text-base">
                <li>Visualize the curve in real-time SVG rendering</li>
                <li>Animate the phase dynamically with adjustable speed</li>
                <li>Fine-tune all parameters: radii, offset, phase, stroke, and color</li>
                <li>Export your design as an SVG file</li>
                <li>Monitor FPS for smooth performance</li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-8 sm:mb-12">
            ...
            <div className="bg-white/[0.02] backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border border-white/[0.08]">
              <p className="text-gray-400 font-light mb-3 sm:mb-4 text-sm sm:text-base">
                The hypotrochoid is defined by:
              </p>
...
y(t) = (R - r) * sin(t) - d * sin(((R - r)/r) * t + phaseShift)`}
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-1 mt-2 text-sm sm:text-base">
                ...
                <li><code className="bg-black/50 px-1 rounded text-xs sm:text-sm">d</code>: Offset of the pen from the center of the rolling circle</li>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
              ...
              <div className="bg-white/[0.02] backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/[0.08]">
                ...
                <p className="text-gray-400 font-light text-sm sm:text-base mb-2">
                  The main canvas renders the curve dynamically and includes:
                </p>
                <ul className="list-disc list-inside text-gray-300 space-y-1 text-sm sm:text-base">
                  <li>Play/Pause toggle</li>
                  <li>Real-time phase display in radians and degrees</li>
                  <li>Color picker popup</li>
                  <li>Download button for exporting SVG</li>
                </ul>
              </div>
              ...
              <div className="bg-white/[0.02] backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/[0.08]">
                ...
                <p className="text-gray-400 font-light text-sm sm:text-base mb-2">
                  Use sliders and buttons to adjust:
                </p>
                <ul className="list-disc list-inside text-gray-300 space-y-1 text-sm sm:text-base">
                  <li>Fixed and rolling radii (<code className="bg-black/50 px-1 rounded text-xs sm:text-sm">R</code>, <code className="bg-black/50 px-1 rounded text-xs sm:text-sm">r</code>)</li>
                  <li>Pen offset distance (<code className="bg-black/50 px-1 rounded text-xs sm:text-sm">d</code>)</li>
                  <li>Manual phase shift (disabled while animating)</li>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
              <div className="bg-white/[0.02] rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/[0.08]">
                ...
                <p className="text-gray-400 font-light text-sm sm:text-base">
                  Toggle the animation loop. When paused, you can manually adjust the phase slider.
                </p>
              </div>
              <div className="bg-white/[0.02] rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/[0.08]">
                <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                ...
                <p className="text-gray-400 font-light text-sm sm:text-base">
                  Use the custom arc-based picker to select stroke color and adjust grain intensity.
                </p>
              </div>
              <div className="bg-white/[0.02] rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/[0.08] md:col-span-2 lg:col-span-1">
                ...
                <p className="text-gray-400 font-light text-sm sm:text-base">
                  Export your current curve as a high-resolution SVG file.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-8 sm:mb-12">
            ...
            <div className="bg-white/[0.02] backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/[0.08]">
              <p className="text-gray-400 font-light mb-3 sm:mb-4 text-sm sm:text-base">
                The animation loop uses <code className="bg-black/50 px-1 rounded text-xs sm:text-sm">requestAnimationFrame</code> for smooth performance. FPS is color-coded:
              </p>
              <ul className="list-disc list-inside text-gray-300 space-y-1 text-sm sm:text-base">
                <li>Green ≥ 55 FPS</li>
                <li>Yellow ≥ 30 FPS</li>
          ...
          <section className="mt-8 sm:mt-12 lg:mt-16 mb-4 sm:mb-6 lg:mb-8 text-center">
            ...
            >
              Hypotrochoid Editor
              <HypotrochoidLogo className="w-12 h-12 sm:w-16 sm:h-16" />
            </a>
...
export default HypotrochoidDocs;