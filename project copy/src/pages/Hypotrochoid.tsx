...
function Hypotrochoid() {
  const [params, setParams] = useState<HypotrochoidParams>({
    R: 100,
    r: 30,
    d: 60,
    amplitude: 150,
  ...
  const updateParam = useCallback((key: keyof HypotrochoidParams, value: number | string) => {
  ...
  const downloadSVG = useCallback(() => {
    ...
    link.href = url;
    link.download = `hypotrochoid-curve-${Date.now()}.svg`;
  ...
  return (
    <div className="min-h-screen bg-black overflow-x-hidden">
      <Helmet>
        <title>Designer | Hypotrochoid</title>
      </Helmet>
      <Topbar />
